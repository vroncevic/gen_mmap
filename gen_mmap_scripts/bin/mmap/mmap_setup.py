...
class MMAPSetup(object):
    """
        Define class MMAPSetup with attribute(s) and method(s).
        ...
        It defines:
            ...
            method:
                ...
                gen_mmap_setup - Generate project skeleton
    """

    __slots__ = ('VERBOSE')
    VERBOSE = 'GEN_MMAP::MMAP_SETUP::MMAPSETUP'
    ...
    def __init__(self, verbose=False):
        """
            ...
            :exceptions: None
        """
        verbose_message(MMAPSetup.VERBOSE, verbose, 'Initial setup')
        pass

    def gen_mmap_setup(self, project_name, verbose=False):
        """
