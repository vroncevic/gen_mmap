...
Info
    Validator for the gen_mmap bundle dependencies.
'''
...
class GenMmapBundleDependenciesValidator:
    '''
        Validator for the gen_mmap bundle dependencies.
    ...
    @classmethod
    def validate(cls, dependencies: GenMmapBundleDependencies) -> None:
        '''
            Validates the gen_mmap bundle dependencies.

            :param dependencies: The gen_mmap bundle dependencies to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_mmap_bundle_dependencies_validator::validate(...)'
        msg_dependencies_none: str = 'the gen_mmap bundle dependencies must be provided'
        msg_dependencies_istype: str = 'the gen_mmap bundle dependencies must be a Mapping'

        not_none(dependencies, ctx, msg_dependencies_none)
        istype(dependencies, Mapping, ctx, msg_dependencies_istype)

        for attr_name, expected_type in GenMmapBundleKeys.get_dependency_to_type().items():
