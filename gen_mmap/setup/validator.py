...
Info
    A validator for the gen_mmap bundle.
'''
...
class GenMmapBundleValidator:
    ...
    @classmethod
    def validate(cls, bundle: GenMmapBundle) -> None:
        '''
            Validates the gen_mmap bundle.

            :param bundle: The gen_mmap bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_mmap_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_mmap bundle must be provided'
        msg_bundle_istype: str = 'the gen_mmap bundle must be an instance of GenMmapBundle'
        ...
        istype(bundle, GenMmapBundle, ctx, msg_bundle_istype)
