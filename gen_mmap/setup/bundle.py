...
class GenMmapBundle:
    '''
        GenMmap bundle holding the components of the gen_mmap.

        It defines:

            :attributes:
                | base - The base bundle with the base components.
                | service - The service orchestrating the gen_mmap's execution.
                | subprocessor - The adapter executing the gen_mmap's sub-processes.
                | cli - The command-line interface adapter.
            :methods:
                | to_dict - Converts the gen_mmap bundle to a dictionary.
    '''
    ...
    def to_dict(self) -> dict[str, object]:
        '''
            Converts the gen_mmap bundle to a dictionary.

            :return: Dictionary representation of the gen_mmap bundle.
            :exceptions: None.
        '''
