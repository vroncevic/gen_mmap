...
Info
    Defines GenMmapCommandExecutor class.
'''
...
class GenMmapCommandExecutor:
    '''
        Command executor strategy for generating mmap project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenMmapCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenMmapCommandExecutor as string representation.

            :return: The GenMmapCommandExecutor as string representation.
        '''
        return to_str(self)
