...
Info
    Defines GenMmapCommandDefinition class.
'''
...
class GenMmapCommandDefinition:
    '''
        CLI subcommand metadata definition for mmap project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate Mmap project skeleton'
