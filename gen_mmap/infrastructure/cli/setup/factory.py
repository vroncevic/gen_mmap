...
from gen_mmap.infrastructure.cli.setup.options import CLIBundleOptions
from gen_mmap.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_mmap.infrastructure.cli.setup.bundle import CLIBundle
from gen_mmap.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_mmap.infrastructure.command.icommand_definition import ICommandDefinition
from gen_mmap.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenMmapCommandDefinition()
        service_executor: ICommandExecutor = GenMmapCommandExecutor(definition=service_definition)
