...
'''
 ...
 Info
     Defined class GenMMAPSetup with attribute(s) and method(s).
...
try:
    from gen_mmap.pro.read_template import ReadTemplate
    from gen_mmap.pro.write_template import WriteTemplate
...
class GenMMAPSetup(FileChecking):
    '''
        Defined class GenMMAPSetup with attribute(s) and method(s).
        Generate module file generator_test.py by template and parameters.
        It defines:
            ...
            :methods:
                ...
                | __str__ - dunder method for GenMMAPSetup.
    '''

    GEN_VERBOSE = 'GEN_MMAP::PRO::GEN_SETUP'
    ...
    def gen_setup(self, pro_name, verbose=False):
        ...
        verbose_message(
            GenMMAPSetup.GEN_VERBOSE, verbose, 'generating module', pro_name
        )
    ...
    def __str__(self):
        '''
            Dunder method for GenMMAPSetup.
