...
def main() -> bool:
    '''
        Bootstraps and runs the gen_mmap with required adapters.

        :return: True if successful, False otherwise.
        :exceptions: None
    '''
    gen_mmap: GenMmap = GenMmap(GenMmapBundleFactory.create_bundle())

    return gen_mmap.process()


if __name__ == '__main__':
    '''
        Entry point for gen_mmap execution.
