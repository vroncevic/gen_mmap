...
from gen_mmap.engine import GenMmap
...
class TestGenMmap(unittest.TestCase):
    ...
    def test_engine_process_success(self) -> None:
        ...
        mock_base = BaseBundleFactory.create_bundle(
            options=BaseBundleOptions(
                info_file='gen_mmap/infrastructure/config/gen_mmap.cfg',
                use_generator=True,
    ...
    @patch('gen_mmap.setup.validator.GenMmapBundleValidator.validate')
    ...
    def test_cli_bundle_factory(self) -> None:
        from gen_mmap.infrastructure.cli.setup.factory import CLIBundleFactory
