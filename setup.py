...
Info
    Defines setup for tool gen_mmap.
'''
...
setup(
    name='gen_mmap',
    version='1.0.3',
    description='Generating mmap project',
    ...
    keywords='Unix, Linux, Development, MMAP, Memory map, C, C++, generator',
    platforms='POSIX',
    classifiers=PYP_CLASSIFIERS,
    packages=find_packages(exclude=['tests', 'tests.*', '*.*.pyc', '*.pyo']),
    install_requires=['ats-utilities'],
    package_data={'gen_mmap': find_package_data('gen_mmap')}
)
